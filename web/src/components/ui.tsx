...
export const btnPrimary =
  "inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-berry px-5 py-2 text-sm font-semibold text-white shadow-sm transition duration-150 hover:bg-berry-dark active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50";

export const btnSecondary =
  "inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-hairline bg-white px-5 py-2 text-sm font-semibold text-berry shadow-sm transition duration-150 hover:bg-berry/5 active:scale-[0.98] disabled:opacity-50";

export const btnDanger =
  "inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-red-600 px-5 py-2 text-sm font-semibold text-white shadow-sm transition duration-150 hover:bg-red-700 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50";

export const btnDangerGhost =
  "inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-red-200 bg-white px-5 py-2 text-sm font-semibold text-red-600 transition duration-150 hover:bg-red-50 disabled:opacity-50";

export const btnGhost =
  "inline-flex items-center gap-1 whitespace-nowrap rounded-full px-3 py-1.5 text-sm font-medium text-ink/60 transition duration-150 hover:bg-berry/5 hover:text-berry";

/** Small header action ("+ Aggiungi …") used inside cards/sections. */
export const btnChip =
  "whitespace-nowrap rounded-full border border-hairline bg-white px-3 py-1 text-xs font-semibold text-berry shadow-sm transition duration-150 hover:bg-berry/5";
...
export function PageHeader({
  ...
  action?: React.ReactNode;
  /** Berry ring sottile: la pagina corrisponde al contesto di lavoro attivo. */
  highlight?: boolean;
}) {
  return (
    <div
      className={`mb-6 flex flex-wrap items-start justify-between gap-4 ${
        highlight ? "rounded-2xl bg-berry/[0.04] px-4 py-3 ring-1 ring-berry/30" : ""
      }`}
    >
